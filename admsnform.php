     ...
     <body style="background-image:url('./images/inbg.jpg');">
        <form id="adform" action="admsnform.php" method="post">
            <div class="container-fluid">    
                <div class="row">
                  <div class="col-sm-12">
                        <img src="images/c1.png" width="100%" style="box-shadow: 1px 5px 14px #999999; "></img>
                  </div>
                 </div>    
             </div>
            ...
            <table class="frmtbl">
               ...
               <tr>
                     ...
                     <td><select id="col" name="col">
                         <option>--------------------Select--------------------</option>
                         <option>KCD Arts</option>
                         <option>KCD Commerce</option>
                         <option>KCD Science</option>
                         <option>KCD Administration</option>
                         <option>KCD Mathematics</option>
                ...
                <tr>
                 ...
                 <!-- $rs  = mysqli_query($con,"select CONCAT('DE',LPAD(RIGHT(ifnull(max(s_detid),'DE00000000'),8) + 1,8,'0'))  -->
